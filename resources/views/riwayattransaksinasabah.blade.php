...
<head>
    ...
    <title>Riwayat Transaksi - Bijak Sampah</title>
...
<div class="flex min-h-screen bg-gray-50" x-data="{ sidebarOpen: false, activeMenu: 'riwayat-transaksi' }" x-init="activeMenu = 'riwayat-transaksi'">
    {{-- Sidebar --}}
    <aside 
